...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='dialog',
            name='bot',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='chatgpt_bot.telegrambot'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_chat_mode', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='current_chat_mode', to='chatgpt_bot.chat_mode')),
                ('current_model', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, to='chatgpt_bot.gptmodels')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='dialog',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='chatgpt_bot.telegramprofile', verbose_name='ChatGpt User'),
        ),
        migrations.CreateModel(
            name='TextModel',
            fields=[
